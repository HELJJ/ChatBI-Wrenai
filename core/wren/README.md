...
pip install 'wrenai[dm8]'          # DM8 (Dameng)
...
DM8 profiles use the native `dmPython` driver. Keep the password in an
environment variable and use the flat profile format expected by the CLI:
