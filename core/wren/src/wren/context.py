...
# DM8: pip install "wrenai[dm8,memory,ui]"
```
...
DM8 uses the native `dmPython` driver and is planned with Oracle-compatible
identifier quoting because DM8 does not accept MySQL backticks.
